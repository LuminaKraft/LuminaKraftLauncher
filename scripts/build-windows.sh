...
# Build Windows version (Tauri will automatically choose MSI and NSIS for Windows target)
...
echo "Windows build completed! MSI and NSIS installers have been created."

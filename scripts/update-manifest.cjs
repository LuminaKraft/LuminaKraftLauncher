...
const platforms = {
  'darwin-x86_64': `LuminaKraft_Launcher_x86_64.app.tar.gz`,
  'darwin-aarch64': `LuminaKraft_Launcher_aarch64.app.tar.gz`,
  'linux-x86_64': `LuminaKraft_Launcher_amd64.AppImage.tar.gz`,
  'windows-x86_64': `LuminaKraft_Launcher_x64-setup.nsis.zip`
};

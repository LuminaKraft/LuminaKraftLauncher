# Setup Script para Solucion Hibrida LuminaKraft Launcher (PowerShell)
# ====================================================================
...
Write-Host "  LUMINAKRAFT LAUNCHER - SETUP SOLUCION HIBRIDA" -ForegroundColor Green
Write-Host "============================================================================" -ForegroundColor Cyan
Write-Host ""
...
if (Get-Command gh -ErrorAction SilentlyContinue) {
    ...
    Write-Warning "GitHub CLI no encontrado. Configuracion manual requerida para secrets"
}
...
# Verificar si el remote publico ya existe
$remoteExists = $false
try {
...
if ($GH_AVAILABLE) {
    Write-Host "Comandos utiles con GitHub CLI:" -ForegroundColor Blue
...
Write-Success "Setup de la Solucion Hibrida completado"
